...
class TransportTypeControllerTest {
    ...
    @BeforeAll
    static void beforeAll(@Autowired TransportTypeRepository transportTypeRepository) {
        kafka.start();
        createMockKafkaConsumer();
        mongo.start();
        transportTypeRepository.save(mockTransportService1);
        transportTypeRepository.save(mockTransportService2);
    ...
    void findAll() throws Exception {
        ...
        if(transportTypeService.findAll() != null){
            assertThat(transportTypeService.findAll()).contains(mockTransportService1, mockTransportService2);
        }
    }
}