...
class LocationControllerTest {
    ...
    @BeforeAll
    static void beforeAll(@Autowired LocationRepository locationRepository) {
        kafka.start();
    ...
    void findAll() throws Exception {
        ...
        if(locationService.findAll() != null){
            assertThat(locationService.findAll()).contains(mockLocation1, mockLocation2);
        }
    }
}